...
contract TreasuryVester is HederaTokenService, ExpiryHelper, AccessControlEnumerable, Pausable {
    ...
    uint32 private constant MAX_SUPPLY = 230_000_000 * uint32(10)**DECIMALS; // two-hundred-and-thirty million
    uint32 private constant INITIAL_SUPPLY = 11_500_000 * uint32(10)**DECIMALS; // eleven million and five-hundred thousand (airdrop supply)
