...
interface IHTS_Governor {
    ...
    function getNonFungibleTokenInfo(address token, int64 serialNumber) external returns (NonFungibleTokenInfo memory nonFungibleTokenInfo);
}
